...
<table id="scc" class="display">
    <div>
        ...
        <a href="{{url('contrato/create')}}" class="btn btn-primary btn-md  ms-auto" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nova Sala">Cadastrar Contrato </a> 
    </div>
    <thead>
    ...
    <tbody>
        ...
        <tr>
           ...
           <td> {{ date('d/m/Y', strtotime($contrato->publicado)) }}</td>
            {{-- <td>{{$contrato->data}}</td> --}}
            {{-- <td>{{$contrato->publicado}}</td>  --}}
            <td>  
                {{ date('d/m/Y', strtotime($contrato->fim)) }}</td> 
            {{-- <td>{{$contrato->fim}}</td>    --}}
