                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-center"> <!-- Use text-center para alinhar o texto horizontalmente -->
                                    <h4 class="font-weight-bolder">Sistema Controlador de Contratos</h4>
                                </div>
                            </div>
                                <div class="card-body">
